      ...
      <main className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          <button
            ...
            className="group flex flex-col items-start rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-8 text-left shadow-sm transition-all hover:border-indigo-400 hover:shadow-md"
          >
            <div className="mb-4 flex size-14 items-center justify-center rounded-xl bg-indigo-100 dark:bg-indigo-900 text-3xl transition-colors group-hover:bg-indigo-200">
              🏗️
            </div>
            <h2 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">Build with Template</h2>
            ...
            <ul className="mb-8 space-y-1.5 text-xs text-slate-400 dark:text-slate-500">
          ...
          <button
            ...
            className="group flex flex-col items-start rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-8 text-left shadow-sm transition-all hover:border-emerald-400 hover:shadow-md"
          >
            <div className="mb-4 flex size-14 items-center justify-center rounded-xl bg-emerald-100 dark:bg-emerald-900 text-3xl transition-colors group-hover:bg-emerald-200">
              🧩
            </div>
            <h2 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">Download a Skill</h2>
            <p className="mb-6 text-sm leading-relaxed text-slate-500 dark:text-slate-400">
              Already have a project? Browse the skill library, pick the behaviour packs you need,
              and download them as <code className="rounded bg-slate-100 dark:bg-gray-700 px-1">SKILL.md</code> files
              ready to drop into your <code className="rounded bg-slate-100 dark:bg-gray-700 px-1">skills/</code>{" "}
              folder.
            </p>
            <ul className="mb-8 space-y-1.5 text-xs text-slate-400 dark:text-slate-500">
              <li className="flex items-center gap-2">
          ...
          <button
            ...
            className="group flex flex-col items-start rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-8 text-left shadow-sm transition-all hover:border-violet-400 hover:shadow-md"
          >
            <div className="mb-4 flex size-14 items-center justify-center rounded-xl bg-violet-100 dark:bg-violet-900 text-3xl transition-colors group-hover:bg-violet-200">
              🔨
            </div>
            <h2 className="mb-2 text-xl font-bold text-slate-900 dark:text-white">Build a Skill</h2>
            <p className="mb-6 text-sm leading-relaxed text-slate-500 dark:text-slate-400">
              Write or generate your own <code className="rounded bg-slate-100 dark:bg-gray-700 px-1">SKILL.md</code>{" "}
